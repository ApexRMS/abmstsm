...
to setup-gis
  ...
  set stateclass-layer gis:load-dataset "_dataDir_/stateclass_crntbsn_100.asc" ;load stateclass raster
...
@#$#@#$#@
<experiments>
  <experiment name="ABM Only -- 30 years, 50 iterations" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="30"/>
    <metric>[biomass] of patches</metric>
    <metric>mean [biomass] of patches</metric>
    <metric>[stateclass] of patches</metric>
  </experiment>
